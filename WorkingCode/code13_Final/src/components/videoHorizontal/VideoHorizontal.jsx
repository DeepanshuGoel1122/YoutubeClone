...
const VideoHorizontal = ({ video, searchScreen, subScreen }) => {
  ...
  const { id,
    snippet: { channelId, channelTitle, description, title, publishedAt, thumbnails: { medium }, resourceId }
  } = video
  ...
  return (
    <Row className="videoHorizontal m-1 py-2 align-items-center" onClick={handleClick}>
      ...
      <Col xs={6} md={searchScreen || subScreen ? 6 : 6} className="videoHorizontal__right p-0">
